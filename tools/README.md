...
This directory contains development tools, configurations, and utilities for code quality, consistency, and productivity in the Modulyn ERP platform.
...
def generate_app(app_name):
    ...
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'Modulyn_erp.settings')
