...
A comprehensive human resources management system for the Modulyn ERP platform that handles employee lifecycle, attendance tracking, leave management, payroll processing, performance reviews, training, and policy management.
